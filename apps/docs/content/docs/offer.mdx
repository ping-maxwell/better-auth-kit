...
- [Database Explorer](/docs/cli/database-explorer) - A Better-Auth powered database explorer and schema visualizer.
- [Dashboard](/docs/cli/dashboard) - A Clerk-like dashboard for your Better-Auth project. (Coming Soon)
