...
<GithubButton url="https://github.com/ping-maxwell/better-auth-kit/tree/main/packages/adapters/convex-better-auth" />
<NpmButton url="https://www.npmjs.com/package/convex-better-auth" />
