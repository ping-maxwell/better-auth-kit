...
export function Sidebar() {
  ...
  return (
    <div className="fixed top-0">
      <aside className="border-r border-lines md:flex hidden w-[var(--fd-sidebar-width)] overflow-y-auto absolute top-[64px] h-dvh flex-col justify-between">
        <div>
          {/* <Select
            defaultValue="docs"
            value={group}
           ...
           */}
          <div className="mt-0">
            {/* <h3 className="text-lg ml-3">Docs</h3> */}
          </div>
          <MotionConfig
                              ...
                              <Suspense fallback={<>Loading...</>}>
                                {listItem.group ? (
                                  ...
                                  <AsideLink
                                    ...
                                    className="break-words w-[var(--fd-sidebar-width)]"
                                  >
