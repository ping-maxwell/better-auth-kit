...
export const DBTopbar = ({ table }: { table: Table<any> }) => {
	...
	return (
		<div className="w-full h-16 bg-sidebar border-b border-border flex items-center px-2">
			<SidebarTrigger className="cursor-pointer text-muted-foreground opacity-50" />
			<Breadcrumb className="ml-2">
				<BreadcrumbList>
					<BreadcrumbItem className="cursor-default">Database</BreadcrumbItem>
					<BreadcrumbSeparator />
					<BreadcrumbItem>
						<DropdownMenu>
