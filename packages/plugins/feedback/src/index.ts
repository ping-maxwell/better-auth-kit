...
/**
 * Converts a record of additional field attributes into a Zod validation schema.
 *
 * Each field is mapped to its corresponding Zod type based on its declared type and marked as optional if not required.
 *
 * @param additionalFields - A mapping of field names to their attributes, specifying type and requirement.
 * @returns A Zod object schema representing the additional fields.
 */
